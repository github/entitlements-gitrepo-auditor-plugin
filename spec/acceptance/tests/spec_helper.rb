...
# require_relative "../../lib/entitlements/<your_plugin_files>"
...
# From an array of UIDs, construct the text that would be used in GitRepo files.
def gitrepo_file(people_array)
  people_array.map { |uid| "uid=#{uid},ou=People,dc=kittens,dc=net".downcase }.sort.join("\n") + "\n"
end
